...
set tkscaling [::tk scaling]
append ps_preamable "% Scale font sizes by the [tk scaling] value. 
% This works around an issue whereby fonts are not scaled correctly 
% (see http://wiki.tcl.tk/8483).
/scalefont \{$tkscaling mul scalefont\} bind def
"
